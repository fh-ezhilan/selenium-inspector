...
"[project]/src/hooks/use-page-store.tsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
const PagesContext = /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createContext"])(undefined);
function PagesProvider({ children }) {
    ...
    const [testData, setTestData] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])({
        "PagesProvider.useState": ()=>{
            if ("TURBOPACK compile-time falsy", 0) {
                "TURBOPACK unreachable";
            }
            try {
                ...
                return raw ? JSON.parse(raw) : initialTestData;
            } catch  {
    ...
    const [testCases, setTestCases] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])({
        "PagesProvider.useState": ()=>{
            ...
            try {
                ...
                return raw ? JSON.parse(raw) : initialTestCases;
            } catch  {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "PagesProvider.useEffect": ()=>{
            try {
                window.localStorage.setItem(TESTDATA_KEY, JSON.stringify(testData));
            } catch  {}
        }
    }["PagesProvider.useEffect"], [
        testData
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "PagesProvider.useEffect": ()=>{
            try {
                window.localStorage.setItem(TESTCASES_KEY, JSON.stringify(testCases));
            } catch  {}
        }
    }["PagesProvider.useEffect"], [
        testCases
    ]);
    const getPageById = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "PagesProvider.useCallback[getPageById]": (id)=>pages.find({
                "PagesProvider.useCallback[getPageById]": (p)=>p.id === id
            }["PagesProvider.useCallback[getPageById]"])
    }["PagesProvider.useCallback[getPageById]"], [
        pages
    ]);
    const addPage = (name)=>{
    ...
    const addLocator = (pageId, locator)=>{
        const newLocator = {
            ...locator,
    ...
    const updateLocator = (pageId, locatorId, updates)=>{
        setPages((prev)=>prev.map((p)=>p.id === pageId ? {
                    ...p,
                    locators: p.locators.map((l)=>l.id === locatorId ? {
                            ...l,
                            ...updates
                        } : l)
                } : p));
    };
    const deleteLocator = (pageId, locatorId)=>{
        setPages((prev)=>prev.map((p)=>p.id === pageId ? {
                    ...p,
                    locators: p.locators.filter((l)=>l.id !== locatorId)
                } : p));
    };
    const updatePageMethods = (pageId, methods)=>{
        setPages((prev)=>prev.map((p)=>p.id === pageId ? {
                    ...p,
                    generatedMethods: methods
                } : p));
    };
    const updatePageSource = (pageId, html)=>{
        setPages((prev)=>prev.map((p)=>p.id === pageId ? {
                    ...p,
                    pageSource: html
                } : p));
    };
    const updatePageUrl = (pageId, url)=>{
        setPages((prev)=>prev.map((p)=>p.id === pageId ? {
                    ...p,
                    pageUrl: url
                } : p));
    ...
    const updateTestData = (id, updates)=>{
        setTestData((prev)=>prev.map((d)=>d.id === id ? {
                    ...d,
                    ...updates
                } : d));
    };
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(PagesContext.Provider, {
        value: value,
        children: children
    }, void 0, false, {
...
_s(PagesProvider, "HsjCb9bjwySk3cuxKZqq5zCOBJQ=");
_c = PagesProvider;
function usePages() {
    _s1();
    const context = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useContext"])(PagesContext);
    if (context === undefined) {
        throw new Error("usePages must be used within a PagesProvider");
    }
    return context;
}
_s1(usePages, "b9L3QQ+jgeyIrH0NfHrJ8nn7VMU=");
var _c;
__turbopack_context__.k.register(_c, "PagesProvider");
...
//# sourceMappingURL=src_ec5f2083._.js.map